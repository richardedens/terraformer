...
function getUserDisplayEle(user) {
    return `<div class="user-display-ele">
        ...
        <div class="edit-view">
            <div>
                Name: <input class="form-control name-edit-input" value="${user.name}">
            </div>
            <div>
                Email: <input class="form-control email-edit-input" value="${user.email}">
            </div>
            <button class="btn btn-primary submit-edit-btn" data-user-id="${user.id}">
                Submit
            </button>
            <button class="btn btn-primary cancel-edit-btn" data-user-id="${user.id}">
                Cancel
            </button>
        </div>
    </div>`;
